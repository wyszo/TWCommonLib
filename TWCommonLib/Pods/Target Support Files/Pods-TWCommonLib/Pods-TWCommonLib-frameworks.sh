...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KZAsserts/KZAsserts.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LBDelegateMatrioska/LBDelegateMatrioska.framework"
